...
class CarState(CarStateBase):
  ...
  def update_canfd(self, can_parsers) -> structs.CarState:
    ...
    if corner_infos:
      ...
      corner = True
    if corner:
      left_block = True if 0 < ret.leftLongDist < 7.0 or 0 < self.lr_distance < 5.0 else False
      right_block = True if 0 < ret.rightLongDist < 7.0 or 0 < self.rr_distance < 5.0 else False
      if left_block:
